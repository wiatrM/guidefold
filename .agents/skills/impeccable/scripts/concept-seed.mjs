 ...
 * resources/new-work.md). Left alone, it then always builds its #1 —
    ...
    if (chosenIdx !== -1) {
      ...
      if (!loadContext(process.cwd()).hasProduct) {
        process.stdout.write([
          ...
          'Complete the init ask round and write PRODUCT.md first (resources/init.md), then re-run this exact command.',
