...
4. **The picker is chrome, not a contestant.** Its exact markup, styles, and behavior are specified in [PICKER.md](./resources/PICKER.md) — copy them verbatim. Its look is not a design decision and never adapts to the project.
