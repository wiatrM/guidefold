...
The detailed material for this skill lives in [Implementation techniques](./resources/techniques.md). Read it before applying anything beyond the posture above.
