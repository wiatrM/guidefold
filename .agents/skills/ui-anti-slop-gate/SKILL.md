...
| Stan przekazany wyłącznie animacją, bez etykiety | Etykieta i ton `StateBadge`; animacja tylko jako dodatek do opisanego stanu |
...
dopuszczone wszędzie, bez ograniczenia miejsca, w tym jako ciągły ruch dekoracyjny. Dotyczy to też glassmorphismu
i pulsowania; stan nigdy nie jest przekazany wyłącznie animacją. Wiążące jako dostępność, nie estetyka: `prefers-reduced-motion`,
