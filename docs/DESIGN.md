...
| R7 | Telemetry privacy | prompts stored as hashes only; upload is opt-out and on by default once a token and endpoint exist ([ADR-0048](adr/ADR-0048-telemetry-upload-on-by-default.md), owner decision 2026-09-13, amends this row's earlier "opt-in upload") |
