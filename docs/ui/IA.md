...
Organizację wybiera się przełącznikiem w górnej części raila (nazwa i rola, lista organizacji użytkownika, „Create organization”); ostatnio wybrana organizacja jest zapamiętana w tej przeglądarce, ale `org` w URL zawsze wygrywa, a zapamiętanie niczego nie przyznaje. Zachowanie przełącznika, kreatora i listy repozytoriów z GitHuba: [UX §3a](UX.md).
