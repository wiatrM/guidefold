...
**Status:** Proposed · 2026-09-05 · **numbers revised 2026-09-05 against a real 2 111-skill corpus** · [ADR-0023](ADR-0023-search-use-service-and-measured-utility.md) proposes an amendment; the status here is unchanged. · [ADR-0024](ADR-0024-target-architecture-tiers-flywheel-composer.md) (Proposed) proposes an amendment: sharding is scoped to the local tier T0 · **Parked by** [ADR-0043](ADR-0043-pre-pivot-adr-reconciliation.md) (2026-09-12): no shard code exists; not to be extended without pilot measurements
