...
**Status:** Proposed · 2026-09-04 · v2 replaces v1 of the same day (v1 assumed a small, hierarchy-only library) · [ADR-0023](ADR-0023-search-use-service-and-measured-utility.md) proposes an amendment; the status here is unchanged. · [ADR-0024](ADR-0024-target-architecture-tiers-flywheel-composer.md) (Proposed) proposes an amendment: client-side hybrid becomes tier T0 only · **Parked by** [ADR-0043](ADR-0043-pre-pivot-adr-reconciliation.md) (2026-09-12): query rewrite, family caps and listwise rerank were never built; what shipped is ADR-0020/0022 items 1–3
