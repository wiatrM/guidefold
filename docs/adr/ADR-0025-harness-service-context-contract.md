...
**Status:** Accepted · 2026-09-05 · the product owner approved adding the context contract, service changes and conformance tests before the service PR; [ADR-0039](ADR-0039-proof-gated-source-grounded-delivery.md) (Accepted 2026-09-12 as an opt-in policy only) adds an opt-in proof-gated delivery policy.
