...
**Status:** Proposed · 2026-09-05 · [ADR-0024](ADR-0024-target-architecture-tiers-flywheel-composer.md) (Proposed) proposes an amendment: the composition stage may be a model; [ADR-0039](ADR-0039-proof-gated-source-grounded-delivery.md) (Accepted 2026-09-12 as an opt-in policy) adds a source-proof delivery boundary; [ADR-0037](ADR-0037-nearest-wins-for-same-name-skills.md) (Accepted) amends the policy filter with nearest-wins
