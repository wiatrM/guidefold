...
| [0047](ADR-0047-organisation-is-the-default-read-scope.md) | The organisation is the default read scope; a repository is a filter (`{org_base}` twins of every read, one ACL rule in `mgmt.AuthorizeScope`, contract 1.9.0) | Accepted | 2026-09-13 | relies on ADR-0033, ADR-0042; Live Agent (ADR-0046) already organisation-wide; no `{repo_base}` route or mutation changed |
