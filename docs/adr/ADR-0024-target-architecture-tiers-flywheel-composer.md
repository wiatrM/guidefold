...
**Status:** Proposed · 2026-09-05 · the target system beyond the MVP; nothing here is deployed, trained or admitted by this ADR · request boundary amended by [ADR-0025](ADR-0025-harness-service-context-contract.md) (Accepted); architecture status unchanged · T1 hosting mapped by [ADR-0026](ADR-0026-native-search-paradedb-compose.md); frozen by [ADR-0029](ADR-0029-product-focus-hard-rules.md); tier T2, flywheel and model composer **parked by** [ADR-0043](ADR-0043-pre-pivot-adr-reconciliation.md) (2026-09-12)
