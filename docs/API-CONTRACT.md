...
| Metoda | Ścieżka | Rola / zakres | Wejście | Wyjście | Błędy | Idem. | P / AC |
|---|---|---|---|---|---|---|---|
| POST | `{org_base}/live/runs` | owner + CSRF | `{prompt:str!, provider:str?, model:str?, repos:[]str?}` | `202` `LiveRun` | `invalid_prompt`, `invalid_model`, `model_credential_missing`, `live_run_already_active`, `secret_encryption_unavailable` | tak | ADR-0046 / U4 |
