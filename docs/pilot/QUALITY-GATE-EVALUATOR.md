...
also aggregates harness errors, SEARCH calls, returned search results, search errors, USE/ASK
counts, input/output tokens, tool calls and elapsed time. An unobserved metric is `null`; an
