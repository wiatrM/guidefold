...
| [ACT-01-RUNBOOK](ACT-01-RUNBOOK.md) | Kroki produkcyjne Pilot Core dla właściciela: lista przedlotowa, komenda albo klik na każdy krok i zapytanie dowodowe po nim. Napisany z dwóch lokalnych prób generalnych ([pierwsza](../reports/pilot/2026-09-15-pilot-core-rehearsal.md), [druga, na scalonym `main`](../reports/pilot/2026-09-15-pilot-core-rehearsal-v2.md)), więc sam jest dowodem R; dowód P powstaje dopiero przy jego wykonaniu. |
| [PREREG harness-conditional evolution](../reports/research/PREREG-harness-conditional-evolution-2026-09-15.md) | Pre-rejestracja badania „czy biblioteka ewoluuje inaczej per harness" (H1 divergence, H2 transfer, H3 core+overlay): jednostka permutacji, dane z ledgera, moc dla 20 sesji, stop rules, procedura zamrożenia sha256. Nie jest protokołem pilota ani zmianą E6.7; nie zmienia rankingu. |
