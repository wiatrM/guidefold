...
`guidefold.yaml` **nie jest potrzebny do importu** (ADR-0050). Dopisz go tylko wtedy, gdy po §4 zobaczysz w Map › Scopes jeden węzeł `_root` i chcesz innej hierarchii. Wzór, który druga próba potwierdziła jako działający:
