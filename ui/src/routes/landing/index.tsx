  ...
  <main id="main" tabIndex={-1}>{emailAction?<EmailAction {...emailAction}/>:<>
   ...
   <section className={css.availability} aria-label="Product availability">
    <div className={css.availabilityStatements}>
     ...
     <p><strong>Hosting is planned.</strong> Sign up for availability updates.</p>
    </div>
   ...
   <section className={css.waitlist} aria-labelledby="waitlist-title">
    <div className={css.waitlistCopy}><h2 id="waitlist-title">Want to know when hosting is ready?</h2><p>One email when hosted Guidefold is ready. Nothing else.</p></div>
    <WaitlistForm/>
   </section>
